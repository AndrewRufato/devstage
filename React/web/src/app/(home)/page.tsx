  ...
  return (
      ...
      <div className="min-h-dvh flex flex-col justify-center gap-16">  
        <div className="flex flex-col gap-8 items-center md:items-start"> 
          ...
          <h1 className='text-4xl text-center leadin-none font-heading font-medium flex flex-col md:text-7xl md:text-left'> 
            <span>CodeCraft</span> Submit 2025
          </h1>
        </div>
