    ...
    return(
        <div className="min-h-dvh flex items-center justify-between gap-16 flex-col md:flex-row">
            ...
            <div className='space-y-2'>
                <h1 className='text-2xl font-semibold font-heading text-gray-100 leading-none'>Inscrição confirmada</h1>
                <p className='text-gray-300'> Para entrasr no evento, acesse o link enviado para seu e-mail.</p>
            </div>
